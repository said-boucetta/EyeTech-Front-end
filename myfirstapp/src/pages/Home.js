...
const Home = () => {
  ...
  const flip = () => {
    const [fliping, setShow] = useState(false);
      ...
      <div className="secondPage">
        ...
        <div className="containerCard">
          <div className="card">
            ...
            <div className="bottom-text">
              <div className="text">
                ...
                connaissances dans le domaine de la réparation des smartphones.
              </div>
            </div>
          </div>
          <div className="card">
          ...
          <div className="card">
            ...
            <div className="bottom-text">
              <div className="text">
                Cette formation est pour apprendre a manipuler le matériel de la
                programmation avec "Nand Programmin", et les techniques de
                l'Icloud.
              </div>
            </div>
          </div>
            ...
            <div className="card4" >
              <div className="inner-box" id="card" >
                <div className="card-front" >
                  <h2>Login</h2>
                  <form>
                    <input type="email" className="input-box" placeholder="E-mail" required />
                    <input type="password" className="input-box" placeholder="Mot de passe" required />
                    <button type="submit" className="submit-btn" >Valider</button>
                    <input type="checkbox"/> <span>Remember me</span>
                  </form>
                  <button type="button" className="btn"  >Je m'inscris</button>
                ...
                <h2>Inscription</h2>
                  <form>
                    <input type="text" className="input-box" placeholder="Nom et Prénom" required />
                    <input type="email" className="input-box" placeholder="E-mail" required />
                    <input type="password" className="input-box" placeholder="Mot de passe" required />
                    <button type="submit" className="submit-btn" >Valider</button>
                    <input type="checkbox"/> <span>Remember me</span>
                  </form>
                  <button type="button" className="btn"  >J'ai déja un compte</button>
